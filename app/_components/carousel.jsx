...
export default function Carousel({
  ...
  return (
    <div className="relative w-full bg-transparent h-full rounded-xl">
      ...
      <div className="w-full h-full my-auto absolute flex items-center justify-items-center px-1 md:px-5 justify-between">
      <button
      ...
      <div className="w-full h-full">
        <Image
          ...
          height="533"
          preload="true"
          className="object-scale-down object-center w-full h-full rounded-xl"
        />
      </div>
    </div>
  );
